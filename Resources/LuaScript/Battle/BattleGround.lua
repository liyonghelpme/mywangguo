...
function BattleGround:initMenu()
    ...
    temp = ui.newBMFontLabel({text="21", size=25, font="bound.fnt"})
    temp:setAnchorPoint(CCPointMake(0, 0.5))
    temp:setPosition(941, 19)
    top:addChild(temp)
    temp = ui.newBMFontLabel({text="21", size=25, font="bound.fnt"})
    temp:setAnchorPoint(CCPointMake(0, 0.5))
    temp:setPosition(53, 19)
    top:addChild(temp)
    temp = ui.newBMFontLabel({text="Lv", size=25, color=ccc3(166,92,20), font="bound.fnt"})
    temp:setAnchorPoint(CCPointMake(0, 0.5))
    ...
    top:addChild(temp)
    temp = ui.newBMFontLabel({text="Left Rounds: 23", size=25, color=ccc3(166,92,20), font="bound.fnt"}) 
    temp:setAnchorPoint(CCPointMake(0.5, 0.5))
