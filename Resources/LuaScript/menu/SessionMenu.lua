...
function SessionMenu:ctor(word, callback, del)
    ...
    local w = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text=word, align=ui.TEXT_ALIGN_LEFT, valign=ui.TEXT_VALIGN_TOP, size=28, color={255, 255, 255}, font="f1", shadowColor={0, 0, 0}})), {0.00, 1.00}), {255, fixY(sz.height, 325)})
