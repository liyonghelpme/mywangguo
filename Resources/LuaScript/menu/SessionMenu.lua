...
function SessionMenu:ctor(word, callback, del, param)
    ...
    local w = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text=word, dimensions=CCSizeMake(540, 768), align=ui.TEXT_ALIGN_LEFT, valign=ui.TEXT_VALIGN_TOP, size=28, color={255, 255, 255}, font="f1", shadowColor={0, 0, 0}})), {0.00, 1.00}), {255, fixY(sz.height, 310)})
