...
function ConfigMenu:ctor(ct)
    ...
    local but = ui.newButton({image="butc.png", text="配置调整", font="f1", size=27, delegate=self, callback=self.onBut, param=1, shadowColor={0, 0, 0}, color={255, 255, 255}})
    ...
    local but = ui.newButton({image="butc.png", text="参加者", font="f1", size=27, delegate=self, callback=self.onBut, param=2, param=2, shadowColor={0, 0, 0}, color={255, 255, 255}})
