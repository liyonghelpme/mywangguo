...
function IncSoldierMenu:ctor()
    ...
    local w3 = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text="12345银币", size=25, color={248, 181, 81}, font="f1"})), {1.00, 0.50}), {780, fixY(sz.height, 328)})
    ...
    local w3 = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text="12345银币", size=25, color={248, 181, 81}, font="f1"})), {1.00, 0.50}), {780, fixY(sz.height, 373)})
    table.insert(self.words, {w1, w2, w3})
    ...
    local w3 = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text="12345银币", size=25, color={254, 7, 1}, font="f1"})), {1.00, 0.50}), {780, fixY(sz.height, 417)})
    table.insert(self.words, {w1, w2, w3})
    ...
    local w3 = setPos(setAnchor(addChild(self.temp, ui.newTTFLabel({text="无法运用", size=25, color={149, 149, 149}, font="f1"})), {1.00, 0.50}), {780, fixY(sz.height, 458)})
    table.insert(self.words, {w1, w2, w3})
