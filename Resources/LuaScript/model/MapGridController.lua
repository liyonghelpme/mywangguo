...
function MapGridController:addBuilding(chd)
    ...
    --房屋建筑物
    --11 效果建筑物
    if chd.picName == 'build' and chd.data ~= nil and (chd.data.kind == 0 or chd.data.kind == 4 or chd.data.kind == 5 or chd.data.kind == 11 or chd.data.kind == 12 or chd.data.kind == 13 or chd.data.kind == 14 or chd.data.kind == 2) then
