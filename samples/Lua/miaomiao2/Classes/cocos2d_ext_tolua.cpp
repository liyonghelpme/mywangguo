...
static int tolua_Cocos2d_setGLProgram00(lua_State* tolua_S)
{
...
#endif
	{
        ...
        char* vert = ((char*)  tolua_tostring(tolua_S,3,0));
        char* frag = ((char*)  tolua_tostring(tolua_S,4,0));
...
static int tolua_Cocos2d_addETCImage00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if(
...
#endif
 {
    char* pszFileName = ((char*)  tolua_tostring(tolua_S,1,0));
    CCTexture2D *tolua_ret = addETCImage(pszFileName);
...
TOLUA_API int tolua_ext_reg_modules(lua_State* tolua_S)
{
  ...
  tolua_function(tolua_S,"addETCImage", tolua_Cocos2d_addETCImage00);
