Pool = class(FuncBuild)
function Pool:ctor(b)
    --self.inEffect = false
end

function Pool:initView()
    ...
    for i =0, 4, 1 do
        ...
        for j = 0, 4, 1 do
            ...
            if mapDict[key] ~= nil then
                ...
                --2 == 0.1  
                --0.3 6
                if ob.data ~= nil and ob.data.kind == 5 then
                    if dist == 2 then
